...
export const COUNTRY_POLICIES: CountryPolicy[] = [
  {
    ...
    leaveRules: [
      ...
      },
      {
        ...
        minNoticeDays: 0,
        durationLogic: "Payable from day 1 (waiting days abolished 6 April 2026); rate is lower of flat rate or 80% of AWE",
        note: "Use env SSP_WEEKLY_RATE; no Lower Earnings Limit gate from 6 April 2026",
      },
      {
      ...
      },
      {
        ...
        requiresEvidence: true,
        minNoticeDays: 28,
        durationLogic: "1 or 2 weeks (may be non-consecutive) within 52 weeks of birth/adoption; day-one right from 6 April 2026",
        note: "Post-2024 reform: two separate weeks allowed, 28 days' notice, taken any time in the first year",
      },
      {
      ...
      },
      {
        ...
        requiresEvidence: false,
        minNoticeDays: 3,
        durationLogic: "Up to 1 week (≈5 days) unpaid per rolling 12 months; day-one right",
        note: "Carer's Leave Act 2023 (in force 6 April 2024): unpaid leave to care for a dependant with a long-term care need",
      },
      {
        ...
        requiresEvidence: true,
        minNoticeDays: 0,
        durationLogic: "Up to 12 weeks (1 week per 7 full days in neonatal care); day-one right; taken within 68 weeks of birth",
        note: "Statutory Neonatal Care Leave & Pay (in force 6 April 2025); pay is £194.32 or 90% of AWE. Baby born on/after 6 April 2025",
      },
    ],
